...
(function($PS) {
  ...
  "use strict";
  $PS["Accounting.AccountingError"] = $PS["Accounting.AccountingError"] || {};
  var exports = $PS["Accounting.AccountingError"];       
  ...
  var errToString = function (v) {
      if (v instanceof AffjaxError) {
          return "AffjaxError: " + v.value0;
      };
      if (v instanceof JsonError) {
          return "JsonError: " + v.value0;
      };
      throw new Error("Failed pattern match at Accounting.AccountingError (line 22, column 1 - line 22, column 41): " + [ v.constructor.name ]);
  };
  exports["AffjaxError"] = AffjaxError;
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Accounting.UI"] = $PS["Accounting.UI"] || {};
  var exports = $PS["Accounting.UI"];
  ...
  var mkOption = function (item) {
      return Halogen_HTML_Elements.option([ Halogen_HTML_Properties.value(item.v) ])([ Halogen_HTML_Core.text(item.t) ]);
  };
  var mkInput_ = function (inpType) {
      return function (evt) {
          return function (val) {
              if (val instanceof Data_Maybe.Nothing) {
                  return Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(inpType), Halogen_HTML_Properties.classes([ "form-control" ]), Halogen_HTML_Events.onValueChange(evt) ]);
              };
              if (val instanceof Data_Maybe.Just) {
                  return Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(inpType), Halogen_HTML_Properties.classes([ "form-control" ]), Halogen_HTML_Properties.value(val.value0), Halogen_HTML_Events.onValueChange(evt) ]);
              };
              throw new Error("Failed pattern match at Accounting.UI (line 78, column 3 - line 95, column 10): " + [ val.constructor.name ]);
          };
      };
  };
  var mkInput = function (v) {
      return function (inpType) {
          return function (evt) {
              return function (val) {
                  var inp = mkInput_(inpType)(evt)(val);
                  return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "form-group" ]) ])([ Halogen_HTML_Elements.label([  ])([ Halogen_HTML_Core.text(v) ]), inp ]);
              };
          };
      };
  };
  var mkButton = function (v) {
      return function (evt) {
          return Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(evt), Halogen_HTML_Properties.classes([ "btn", "btn-outline-success" ]) ])([ Halogen_HTML_Core.text(v) ]);
      };
  };
  var gridItem = function (v) {
      return function (item) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ v ]) ])([ item ]);
      };
  };
  var emptySelectItem = {
      v: "0",
  ...
  var mkSelect_ = function (items) {
      return function (evt) {
          var opts = Data_Functor.map(Data_Functor.functorArray)(mkOption)(Data_Array.cons(emptySelectItem)(items));
          return Halogen_HTML_Elements.select([ Halogen_HTML_Properties.classes([ "form-control" ]), Halogen_HTML_Events.onValueChange(evt) ])(opts);
      };
  };
  var mkSelect = function (v) {
      return function (items) {
          return function (evt) {
              var sel = mkSelect_(items)(evt);
              return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "form-group" ]) ])([ Halogen_HTML_Elements.label([  ])([ Halogen_HTML_Core.text(v) ]), sel ]);
          };
      };
  };
  exports["gridItem"] = gridItem;
  exports["mkSelect"] = mkSelect;
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Accounting.ModalDialog"] = $PS["Accounting.ModalDialog"] || {};
  var exports = $PS["Accounting.ModalDialog"];
  var Accounting_UI = $PS["Accounting.UI"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];                
  var DialogHidden = (function () {
      ...
      DialogHidden.value = new DialogHidden();
      return DialogHidden;
  })();
  var DialogVisible = (function () {
      function DialogVisible() {

      };
      DialogVisible.value = new DialogVisible();
      return DialogVisible;
  })();
  var dlgStateToClass = function (v) {
      if (v instanceof DialogHidden) {
          return "dlg-hide";
      };
      if (v instanceof DialogVisible) {
          return "dlg-show";
      };
      throw new Error("Failed pattern match at Accounting.ModalDialog (line 27, column 1 - line 27, column 44): " + [ v.constructor.name ]);
  };
  var modalDialog = function (dlgState) {
      return function (ok) {
          return function (cancel) {
              return function (content) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "modalDialog", dlgStateToClass(dlgState) ]) ])([ Halogen_HTML_Elements.div_([ content, Accounting_UI.mkButton("OK")(ok), Accounting_UI.mkButton("Cancel")(cancel) ]) ]);
              };
          };
      };
  };
  exports["DialogHidden"] = DialogHidden;
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Accounting.Hourlist"] = $PS["Accounting.Hourlist"] || {};
  var exports = $PS["Accounting.Hourlist"];
  var Accounting_AccountingError = $PS["Accounting.AccountingError"];
  var Accounting_ModalDialog = $PS["Accounting.ModalDialog"];
  var Accounting_UI = $PS["Accounting.UI"];
  ...
  var NewGroup = (function () {
      ...
      NewGroup.value = new NewGroup();
      return NewGroup;
  })();
  var SelectChange = (function () {
      function SelectChange(value0) {
          this.value0 = value0;
      };
      SelectChange.create = function (value0) {
          return new SelectChange(value0);
      };
      return SelectChange;
  })();
  ...
  var FetchInvoices = (function () {
      function FetchInvoices(value0) {
          this.value0 = value0;
      };
      FetchInvoices.create = function (value0) {
          return new FetchInvoices(value0);
      };
      return FetchInvoices;
  })();
  var NewGroupDlgShow = (function () {
      function NewGroupDlgShow(value0) {
          this.value0 = value0;
      };
      NewGroupDlgShow.create = function (value0) {
          return new NewGroupDlgShow(value0);
      };
      return NewGroupDlgShow;
  })();
  var NewGroupDlgOk = (function () {
      function NewGroupDlgOk(value0) {
          this.value0 = value0;
      };
      NewGroupDlgOk.create = function (value0) {
          return new NewGroupDlgOk(value0);
      };
      return NewGroupDlgOk;
  })();
  var NewGroupDlgCancel = (function () {
      function NewGroupDlgCancel(value0) {
          this.value0 = value0;
      };
      NewGroupDlgCancel.create = function (value0) {
          return new NewGroupDlgCancel(value0);
      };
      return NewGroupDlgCancel;
  })();      
  var newGroupDialog = function (dlgState) {
      var field = Accounting_UI.mkInput("Ny timelistegruppe")(DOM_HTML_Indexed_InputType.InputText.value)(ValueChanged.create(NewGroup.value))(Data_Maybe.Nothing.value);
      var content = Halogen_HTML_Elements.div_([ field ]);
      return Accounting_ModalDialog.modalDialog(dlgState)(NewGroupDlgOk.create)(NewGroupDlgCancel.create)(content);
  };
  var render = function (state) {
      var to = Accounting_UI.gridItem("e1")(Accounting_UI.mkInput("Til")(DOM_HTML_Indexed_InputType.InputTime.value)(SelectChange.create)(Data_Maybe.Nothing.value));
      var spec = Accounting_UI.gridItem("c2")(Accounting_UI.mkInput("Spesifikasjon")(DOM_HTML_Indexed_InputType.InputText.value)(SelectChange.create)(Data_Maybe.Nothing.value));
      var msg = Accounting_UI.gridItem("e2")(Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(state.msg) ]));
      var inv = Accounting_UI.gridItem("a1")(Accounting_UI.mkSelect("Faktura")(state.invoices)(SelectChange.create));
      var hours = Accounting_UI.gridItem("a2")(Accounting_UI.mkInput("Timer")(DOM_HTML_Indexed_InputType.InputNumber.value)(SelectChange.create)(Data_Maybe.Nothing.value));
      var groups = Accounting_UI.gridItem("b1")(Accounting_UI.mkSelect("Gruppe")(state.hourlistGroups)(SelectChange.create));
      var from = Accounting_UI.gridItem("d1")(Accounting_UI.mkInput("Fra")(DOM_HTML_Indexed_InputType.InputTime.value)(SelectChange.create)(Data_Maybe.Nothing.value));
      var date = Accounting_UI.gridItem("c1")(Accounting_UI.mkInput("Dato")(DOM_HTML_Indexed_InputType.InputDate.value)(SelectChange.create)(Data_Maybe.Nothing.value));
      var btnOk = Accounting_UI.mkButton("Lagre")(FetchInvoices.create);
      var btnNewInvoice = Accounting_UI.mkButton("Ny faktura")(FetchInvoices.create);
      var btnNewGroup = Accounting_UI.mkButton("Ny gruppe")(NewGroupDlgShow.create);
      var btnInit = Accounting_UI.mkButton("Hent faktura")(FetchInvoices.create);
      var btnFakturaposter = Accounting_UI.mkButton("Fakturaposter")(FetchInvoices.create);
      var buttons = Accounting_UI.gridItem("d2")(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex" ]) ])([ btnOk, btnNewGroup, btnNewInvoice, btnFakturaposter, btnInit ]));
      var $$break = Accounting_UI.gridItem("b2")(Accounting_UI.mkInput("Pause")(DOM_HTML_Indexed_InputType.InputNumber.value)(SelectChange.create)(Data_Maybe.Nothing.value));
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "accounting-grid" ]) ])([ inv, hours, groups, $$break, date, spec, from, to, msg, buttons, newGroupDialog(state.dlgNewGroup) ]);
  };
  var mainURL = "/hourlist";
  var newGroupURL = mainURL + "/newgroup";
  var saveNewGroup = function (dictMonadAff) {
      return function (newGroup) {
          var payload = Affjax_RequestBody.json(Data_Argonaut_Core.jsonSingletonObject("name")(Data_Argonaut_Core.fromString(newGroup)));
          return Effect_Aff_Class.liftAff(dictMonadAff)(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.post(Affjax_ResponseFormat.json)(newGroupURL)(new Data_Maybe.Just(payload)))(function (res) {
  ...
  var initDataFromJson = Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonNil)({
      ...
      reflectSymbol: function () {
          return "hourlistgroups";
      }
  })()())());
  var fetchInitData = function (dictMonadAff) {
      return Effect_Aff_Class.liftAff(dictMonadAff)(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(initURL))(function (res) {
          var result = (function () {
              if (res instanceof Data_Either.Left) {
                  return Data_Either.Left.create(new Accounting_AccountingError.AffjaxError(Affjax.printError(res.value0)));
              };
              if (res instanceof Data_Either.Right) {
                  var initData = initDataFromJson(res.value0.body);
                  if (initData instanceof Data_Either.Left) {
                      return Data_Either.Left.create(new Accounting_AccountingError.JsonError(Data_Show.show(Data_Argonaut_Decode_Error.showJsonDecodeError)(initData.value0)));
                  };
                  if (initData instanceof Data_Either.Right) {
                      return new Data_Either.Right(initData.value0);
                  };
                  throw new Error("Failed pattern match at Accounting.Hourlist (line 111, column 15 - line 115, column 34): " + [ initData.constructor.name ]);
              };
              throw new Error("Failed pattern match at Accounting.Hourlist (line 104, column 11 - line 115, column 34): " + [ res.constructor.name ]);
          })();
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          ...
          if (v instanceof FetchInvoices) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_MouseEvent.toEvent(v.value0))))(fetchInitData(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))))(function (initData) {
                  if (initData instanceof Data_Either.Left) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          var $27 = {};
                          for (var $28 in st) {
                          ...
                          $27.msg = "Fetch invoices FAIL: " + Accounting_AccountingError.errToString(initData.value0);
                          return $27;
                      });
                  };
                  if (initData instanceof Data_Either.Right) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $31.msg = "Fetch invoices";
                          $31.invoices = initData.value0.invoices;
                          $31.hourlistGroups = initData.value0.hourlistgroups;
                          return $31;
                      });
                  };
                  throw new Error("Failed pattern match at Accounting.Hourlist (line 223, column 7 - line 230, column 32): " + [ initData.constructor.name ]);
              });
          };
          if (v instanceof NewGroupDlgShow) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $36 = {};
                  for (var $37 in st) {
                  ...
                  $36.dlgNewGroup = Accounting_ModalDialog.DialogVisible.value;
                  return $36;
              });
          };
          if (v instanceof NewGroupDlgOk) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_MouseEvent.toEvent(v.value0))))(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.newGroup;
              })))(function (ng) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(saveNewGroup(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(ng))(function (initData) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          var $40 = {};
                          for (var $41 in st) {
                          ...
                          $40.dlgNewGroup = Accounting_ModalDialog.DialogHidden.value;
                          $40.msg = st.newGroup;
                          return $40;
                      });
                  });
          ...
          if (v instanceof NewGroupDlgCancel) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $44 = {};
                  for (var $45 in st) {
                  ...
                  $44.dlgNewGroup = Accounting_ModalDialog.DialogHidden.value;
                  return $44;
              });
          };
          if (v instanceof ValueChanged) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $48.newGroup = v.value1;
                  return $48;
              });
          };
          throw new Error("Failed pattern match at Accounting.Hourlist (line 217, column 16 - line 241, column 41): " + [ v.constructor.name ]);
      };
  };
      ...
      return Halogen_Component.mkComponent({
          initialState: function (v) {
              return {
                  ...
                  newGroup: "",
                  dlgNewGroup: Accounting_ModalDialog.DialogHidden.value
              };
          },
          render: render,
...
(function($PS) {
  ...
  $PS["Main"] = $PS["Main"] || {};
  var exports = $PS["Main"];
  var Accounting_Hourlist = $PS["Accounting.Hourlist"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Control_Apply.applySecond(Effect_Aff.applyAff)(Halogen_Aff_Util.awaitLoad)(Halogen_Aff_Util.selectElement("#ps-hourlist")))(function (node) {
      if (node instanceof Data_Maybe.Nothing) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.logShow(Data_Show.showString)("No such element"));
      };
      if (node instanceof Data_Maybe.Just) {
          return Control_Apply.applySecond(Effect_Aff.applyAff)(Halogen_VDom_Driver.runUI(Accounting_Hourlist.component(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(node.value0))(Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Unit.unit));
      };
      throw new Error("Failed pattern match at Main (line 18, column 9 - line 23, column 26): " + [ node.constructor.name ]);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();