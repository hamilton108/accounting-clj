...
(function($PS) {
  ...
  var mkSelect_ = function (items) {
      return function (evt) {
          var opts = Data_Functor.map(Data_Functor.functorArray)(mkOption)(items);
...
(function($PS) {
  ...
  var CbChange = (function () {
      function CbChange(value0) {
          this.value0 = value0;
      };
      CbChange.create = function (value0) {
          return new CbChange(value0);
      };
      return CbChange;
  })();
  ...
  var render = function (state) {
      var txt = Accounting_UI.gridItem("b2")(Accounting_UI.mkInput("Msg")(DOM_HTML_Indexed_InputType.InputText.value)(SelectChange.create));
      var msg = Accounting_UI.gridItem("a2")(Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(state.msg) ]));
      var inv = Accounting_UI.gridItem("b1")(Accounting_UI.mkSelect("Faktura")(state.invoices)(SelectChange.create));
      var fetchInvBtn = Accounting_UI.gridItem("a1")(Accounting_UI.mkButton("Hent faktura")(FetchInvoices.create));
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "accounting-grid" ]) ])([ inv, txt, msg, fetchInvBtn ]);
  };
      ...
      return Effect_Aff_Class.liftAff(dictMonadAff)(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(initURL))(function (res) {
          var result = (function () {
              ...
              if (res instanceof Data_Either.Right) {
                  ...
                  throw new Error("Failed pattern match at Accounting.Hourlist (line 77, column 15 - line 81, column 34): " + [ initData.constructor.name ]);
              };
              throw new Error("Failed pattern match at Accounting.Hourlist (line 70, column 11 - line 81, column 34): " + [ res.constructor.name ]);
          })();
      ...
      return function (v) {
          ...
          if (v instanceof FetchInvoices) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_MouseEvent.toEvent(v.value0))))(fetchInitData(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))))(function (initData) {
                  ...
                  throw new Error("Failed pattern match at Accounting.Hourlist (line 134, column 7 - line 138, column 85): " + [ initData.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Accounting.Hourlist (line 127, column 16 - line 138, column 85): " + [ v.constructor.name ]);
      };
  };
