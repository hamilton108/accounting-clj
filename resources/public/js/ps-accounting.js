...
(function($PS) {
  ...
  var mkOption = function (item) {
      return Halogen_HTML_Elements.option([ Halogen_HTML_Properties.value(item.val) ])([ Halogen_HTML_Core.text(item.tx) ]);
  };
  ...
  var mkCheckbox = function (v) {
      return function (evt) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "form-group" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "checkbox" ]) ])([ Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.classes([ "fake-cb" ]), Halogen_HTML_Events.onChecked(evt) ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "fake-input" ]) ])([  ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "fake-label" ]) ])([ Halogen_HTML_Core.text(v) ]) ]) ]) ]);
      };
  };
...
(function($PS) {
  ...
  var render = function (state) {
      var txt = Accounting_UI.gridItem("a2")(Accounting_UI.mkInput("Msg")(DOM_HTML_Indexed_InputType.InputText.value)(SelectChange.create));
      var msg = Accounting_UI.gridItem("b1")(Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(state.msg) ]));
      var inv = Accounting_UI.gridItem("a1")(Accounting_UI.mkSelect("Faktura")(state.invoices)(SelectChange.create));
      var cb = Accounting_UI.gridItem("b2")(Accounting_UI.mkCheckbox("Demo")(CbChange.create));
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "accounting-grid" ]) ])([ inv, txt, msg, cb ]);
  };
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Accounting.Hourlist (line 58, column 16 - line 61, column 61): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Control_Apply.applySecond(Effect_Aff.applyAff)(Halogen_Aff_Util.awaitLoad)(Halogen_Aff_Util.selectElement("#ps-hourlist")))(function (node) {
      ...
      if (node instanceof Data_Maybe.Just) {
          return Control_Apply.applySecond(Effect_Aff.applyAff)(Halogen_VDom_Driver.runUI(Accounting_Hourlist.component)(Data_Unit.unit)(node.value0))(Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Unit.unit));
      };
